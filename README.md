...
Currently you can add a new tail-to-tail table prediction in the RE unit to cover this case, but metric evaluation, data processing and such require modification as well. Or you can switch head-to-head prediction in RE table to Tail-to-Tail if your dataset has much less triples that contain tail-overlap triples.  
